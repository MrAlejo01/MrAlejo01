...
<body>
    ...
    <header>
        <h1>BillinIQ</h1>
        <img src="LOGO.png" alt="Logo de BillinIQ" />
    </header>
    ...
    <section id="creacion-facturas" style="display: none;">
        ...
        <form id="facturaForm" action="GenerarFacturaServlet" method="post">
            ...
            <div id="juridicaCampos" style="display:none;">
                ...
                <input type="text" id="nit" name="nit" readonly required aria-required="true" />
            </div>
    ...
    <section id="registro-cliente" style="display: none;">
        ...
        <form id="registroClienteForm" action="RegistrarClienteServlet" method="post">
    ...
    <script>
        ...
        function buscarCliente() {
            ...
            fetch('BuscarClienteServlet?query=' + encodeURIComponent(input))
        ...
        function completarFormularioCliente(cliente) {
            ...
            document.getElementById('juridicaCampos').style.display = cliente.tipo === 'persona-juridica' ? 'block' : 'none';
